...
function assembler2pipepicturesBioreactor()
  return
  {
    ...
    east =
    {
      filename = "__Bio_Farm__/graphics/entities/bioreactor/pipe-east.png",
      priority = "extra-high",
      width = 41,
      height = 40,
      shift = {-0.71875, 0}
    ...
    south =
    {
      filename = "__Bio_Farm__/graphics/entities/bioreactor/pipe-south.png",
      priority = "extra-high",
      width = 41,
      height = 40,
      shift = {0.0625, -0.8}
    ...
    west =
    {
      filename = "__Bio_Farm__/graphics/entities/bioreactor/pipe-west.png",
      priority = "extra-high",
      width = 41,
      height = 40,
      shift = {0.78125, 0.03125}
